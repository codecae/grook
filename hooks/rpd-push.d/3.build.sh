...
ORACLE_HOME=/u01/oracle/mwhome/Oracle_BI1
STAGE_XML_DIR=/u01/metadata/stage/RPDXML
STAGE_RPD_DIR=/u01/metadata/stage/RPD

. ~/biee.env

biserverxmlexec -P Admin123 -D $STAGE_XML_DIR -O $STAGE_RPD_DIR/stage.rpd
